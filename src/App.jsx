    ...
    <>
      <div className="about-page">
        ...
        <div className="profile">
          <img src="/src/imgs/andy.jpg" alt="Andy" className="profile-pic"/>
        ...
        <div className="profile reverse">
          <img src="/src/imgs/josh.jpg" alt="Josh" className="profile-pic"/>
          <div className="profile-info">
            <name>Josh</name>
        ...
        <div className="profile">
          <img src="/src/imgs/ammar.jpeg" alt="Ammar" className="profile-pic"/>
          <div className="profile-info">
            <name>Ammar</name>
        ...
        <div className="profile reverse">
          <img src="/src/imgs/yukti.jpg" alt="Yukti" className="profile-pic"/>
          <div className="profile-info">
            <name>Yukti</name>
